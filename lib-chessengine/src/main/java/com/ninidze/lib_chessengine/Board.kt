package com.ninidze.chesscomposekmm.data.engine
...
class Board {
    ...
    internal var legalMoveGenerator = LegalMoveGenerator()
    ...
    fun see(move: Int): Int {
        return see(
            ...
            Move.getPieceMoved(move), if (Move.isCapture(move)) Move.getPieceCaptured(
                this,
                move
            ) else 0)
    }
