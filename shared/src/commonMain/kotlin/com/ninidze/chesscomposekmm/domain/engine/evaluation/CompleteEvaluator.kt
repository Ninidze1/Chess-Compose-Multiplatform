...
class CompleteEvaluator : Evaluator() {
    ...
    private var debugPawns = false
    private lateinit var debugSB: StringBuilder
    ...
    override fun evaluate(b: com.ninidze.chesscomposekmm.domain.engine.Board, ai: AttacksInfo): Int {
        if (debug) {
    ...
    private fun evalAttacks(board: com.ninidze.chesscomposekmm.domain.engine.Board, ai: AttacksInfo, us: Int, others: Long): Int {
        var attacks = 0
