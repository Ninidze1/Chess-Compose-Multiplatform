...
class AttacksInfo {
    ...
    private var bbAttacks: BitboardAttacks = BitboardAttacks.getInstance()
    ...
    private var kingAttacks = longArrayOf(0, 0)
     ...
     */
    fun build(board: com.ninidze.chesscomposekmm.domain.engine.Board) {
