...
object BitboardUtils {
    ...
    // Board borders
    const val b_d: Long = 255 // down
    const val b_u: Long = -72057594037927936 // up
    const val b_r: Long = 72340172838076673 // right
    const val b_l: Long = -9187201950435737472 // left

    // Board borders (2 squares),for the knight
    const val b2_d: Long = 65535 // down
    const val b2_u: Long = -281474976710656 // up
    const val b2_r: Long = 217020518514230019 // right
    const val b2_l: Long = -4557430888798830400 // left
    ...
    private val RANK_AND_UPWARDS = longArrayOf(
    ...
    private val RANK_AND_DOWNWARDS = longArrayOf(
            RANK[0],
            RANK[0] or RANK[1],
            RANK[0] or RANK[1] or RANK[2],
            RANK[0] or RANK[1] or RANK[2] or RANK[3],
    ...
    private val BIT_TABLE = intArrayOf(63, 30, 3, 32, 25, 41, 22, 33, 15, 50, 42, 13, 11, 53, 19, 34, 61, 29, 2, 51, 21, 43, 45, 10, 18, 47, 1, 54, 9, 57, 0, 35, 62, 31, 40, 4, 49, 5, 52, 26, 60, 6, 23, 44, 46, 27, 56, 16, 7, 39, 48, 24, 59, 14, 12, 55, 38, 28, 58, 20, 37, 17, 36, 8)
     ...
     */
    private fun changeEndianArray64(sarray: Array<String>): Array<String> {
        sarray.reverse()
        return sarray
    }
    ...
    fun popCount(board: Long): Int {
        ...
        b -= (b shr 1 and k1) // put count of each 2 bits into those 2 bits
    ...
    fun distance(index1: Int, index2: Int): Int {
        return max(
            abs((index1 and 7) - (index2 and 7)),
            abs((index1 shr 3) - (index2 shr 3))
        )
    }
