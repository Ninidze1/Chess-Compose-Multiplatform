package com.ninidze.chesscomposekmm.domain.engine.evaluation
...
object Endgame {
    private const val SCALE_FACTOR_DRAW = 0
    private const val SCALE_FACTOR_DRAWISH = 100
    const val SCALE_FACTOR_DEFAULT = 1000

    private val closerSquares = intArrayOf(0, 0, 100, 80, 60, 40, 20, 10)
    ...
    private var kpkBitbase: KPKBitbase = KPKBitbase()

    /**
     * It may return a perfect knowledge value, a scaleFactor or nothing
     */
    fun evaluateEndgame(board: com.ninidze.chesscomposekmm.domain.engine.Board, scaleFactor: IntArray, whitePawns: Int, blackPawns: Int, whiteKnights: Int, blackKnights: Int, whiteBishops: Int, blackBishops: Int, whiteRooks: Int, blackRooks: Int, whiteQueens: Int, blackQueens: Int): Int {
    ...
    private fun endgameKXK(board: com.ninidze.chesscomposekmm.domain.engine.Board, whiteDominant: Boolean, knights: Int, bishops: Int, rooks: Int, queens: Int): Int {
    ...
    private fun endgameKBNK(board: com.ninidze.chesscomposekmm.domain.engine.Board, whiteDominant: Boolean): Int {
    ...
    private fun endgameKPK(board: com.ninidze.chesscomposekmm.domain.engine.Board, whiteDominant: Boolean): Int {
    ...
    private fun scaleKRPKR(board: com.ninidze.chesscomposekmm.domain.engine.Board, whiteDominant: Boolean): Int {
     ...
     */
    private fun endgameKQKP(board: com.ninidze.chesscomposekmm.domain.engine.Board, whiteDominant: Boolean): Int {
    ...
    private fun endgameKBPKN(board: com.ninidze.chesscomposekmm.domain.engine.Board, whiteDominant: Boolean): Int {
        val dominantColor = if (whiteDominant) Color.W else Color.B
    ...
    private fun endgameKBPKB(board: com.ninidze.chesscomposekmm.domain.engine.Board, whiteDominant: Boolean): Int {
        val dominantColor = if (whiteDominant) Color.W else Color.B
        val dominantBishop = board.bishops and if (whiteDominant) board.whites else board.blacks
        val dominantBishopSquares = BitboardUtils.getSameColorSquares(dominantBishop)
    ...
    private fun scaleKRPPKRP(board: com.ninidze.chesscomposekmm.domain.engine.Board, whiteDominant: Boolean): Int {
        val dominantColor = if (whiteDominant) Color.W else Color.B
