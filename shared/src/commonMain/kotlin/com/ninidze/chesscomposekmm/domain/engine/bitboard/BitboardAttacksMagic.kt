...
class BitboardAttacksMagic : BitboardAttacks() {
    ...
    private var rookMask: LongArray
    private var rookMagic: Array<LongArray?>
    private var bishopMask: LongArray
    private var bishopMagic: Array<LongArray?>
    ...
    init {
        ...
        rookMagic = arrayOfNulls(64)
        bishopMask = LongArray(64)
        bishopMagic = arrayOfNulls(64)
        ...
        while (square != 0L) {
            ...
            for (j in 0 until rookPositions) {
            ...
            for (j in 0 until bishopPositions) {
